return {
    ...
    PROJECT_NAME_EXIST = "A project with this name already exists.",
    CHANGE_DIRECTORY_FAILED = "Failed to change working directory to %s",
    ...
    INFO_LINE_SEARCH_EMPTY = "➤ Press: [s]earch | [p]rojects [w]orkspaces [t]abs [f]iles",
    ...
    SEARCH_QUERY_LEN = "Search query is too short.",
    SEARCH_QUERY_EXIST = "This search query was already used.",
